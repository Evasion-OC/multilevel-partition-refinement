...
miniature end to end without any external data, in this order: two
headline wins, a mesh win near parity, a tie, two known parity-regime
losses, then three larger meshes in the separator-ceiling regime. add20
...
- `crack.graph`: 2D fracture-propagation mesh, n = 10,240.
- `whitaker3.graph`: 2D FEM mesh, n = 9,800.
- `fe_4elt2.graph`: 2D FEM airfoil mesh, n = 11,143.
